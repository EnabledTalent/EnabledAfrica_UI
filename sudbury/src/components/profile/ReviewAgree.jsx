    ...
    <>
      ...
      <div style={styles.formGroup}>
        <label style={styles.label}>
          How did you discover the Enabled Africa talent platform?
        </label>
        <select
          style={styles.select}
      ...
      <div style={styles.termsSection}>
        ...
        <div style={styles.termsText}>
          ...
          <a href="/privacy-policy" style={{ color: "#F26522", textDecoration: "underline" }}>Privacy Policy</a> and{" "}
          <a href="/terms-of-service" style={{ color: "#F26522", textDecoration: "underline" }}>Terms of Service</a>.
        </div>
        <div style={styles.termsText}>
          ...
          <a href="mailto:support@enabledtalent.ca" style={{ color: "#F26522", textDecoration: "underline" }}>support@enabledtalent.ca</a>.
        </div>
        <ul style={styles.termsList}>
          <li style={styles.termsItem}>
            <span style={styles.termsBullet}>•</span>
            Allow Enabled Africa to share your resume, pitch yourself and
            behaviour question video with third parties (ex. prospective
            employers) to consider you for an internship.
          </li>
          <li style={styles.termsItem}>
            <span style={styles.termsBullet}>•</span>
            The Enabled Africa program has the right to remove you from the
            program if you decline more than three interview requests without
            appropriate justification
          </li>
          <li style={styles.termsItem}>
            <span style={styles.termsBullet}>•</span>
            Enabled Africa has the right to remove you from the program if
