      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "#6b7280" }}>
          <svg width="28" height="8" style={{ overflow: "visible" }}>
            <line x1="0" y1="4" x2="28" y2="4" stroke="#006838" strokeWidth="2" strokeLinecap="round" />
          </svg>
          <span>Actual</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "#6b7280" }}>
          <svg width="28" height="8" style={{ overflow: "visible" }}>
            <line x1="0" y1="4" x2="28" y2="4" stroke="#F26522" strokeWidth="2" strokeDasharray="4 4" strokeLinecap="round" />
          </svg>
          <span>Projected</span>
        </div>
      </div>
