...
const DEFAULT_AUTH =
  process.env.REACT_APP_AUTH_BASE_URL || "https://sudburry-auth-service.onrender.com";
const DEFAULT_BUSINESS =
  process.env.REACT_APP_BUSINESS_BASE_URL || "https://sudburry-java-service.onrender.com";
