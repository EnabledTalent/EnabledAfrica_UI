...
const ChatWidget = ({ onClose }) => {
  ...
  const styles = {
    ...
    header: {
      background: "linear-gradient(135deg, #006838 0%, #003d24 100%)",
      color: "#ffffff",
      padding: "20px 24px",
      ...
      alignItems: "center",
      boxShadow: "0 4px 12px rgba(0, 77, 42, 0.25)",
    },
    headerTitle: {
      fontSize: "18px",
      fontWeight: 700,
    ...
    userBubble: {
      ...
      boxShadow: "0 4px 12px rgba(0, 104, 56, 0.25)",
    },
    assistantBubble: {
      background: "#ffffff",
      color: "#374151",
    ...
    sendButton: {
      background: "linear-gradient(135deg, #F26522 0%, #d94f0f 100%)",
      color: "#ffffff",
      border: "none",
      padding: "12px 24px",
      borderRadius: "12px",
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!loading && inputMessage.trim()) {
              e.target.style.background = "#d94f0f";
            }
          }}
          onMouseLeave={(e) => {
            if (!loading && inputMessage.trim()) {
